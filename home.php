    ...
    <nav class="c-breadcrumb" aria-label="パンくずリスト">
      <ol class="c-breadcrumb__list">
        ...
        <li class="c-breadcrumb__item" aria-current="page">
          <span class="current-page">お知らせ</span>
        </li>
      </ol>
    </nav>
    <!-- パンくずリスト -->
      ...
      <div class="p-news__inner l-inner--sm">
          ...
          <li class="p-news__item">
            <article class="p-news__article">
              <a class="p-news__link" href="#">
                <time class="p-news__date" datetime="2025-00-00">2025.00.00.</time>
        ...
        <nav class="p-news__pagination" aria-label="ページナビゲーション">
          <ul class="p-news__pager">
            ...
            <li class="p-news__pagerItem is-current">
              <span class="p-news__pagerBtn" aria-current="page">1</span>
            </li>
            <li class="p-news__pagerItem">
              <a class="p-news__pagerBtn" href="#">2</a>
            </li>
            <li class="p-news__pagerItem">
              <a class="p-news__pagerBtn" href="#">3</a>
            </li>
            <li class="p-news__pagerItem">
              <a
