        ...
        <div class="p-topHero__image">
          <picture>
            <source
              ...
              srcset="<?php echo get_template_directory(); ?>/assets/img/content/home/hero-main.webp"
            />
            <img
            ...
            <li class="p-topNews__item">
              <article class="p-topNews__article">
                <a href="#" class="p-topNews__link">
                  <data value="2025-00-00" class="p-topNews__data"
                    >2025.00.00.</data
                  >
                  <h3 class="p-topNews__title">
                    ここにタイトルが入ります。ここにタイトルが入ります。ここにタイ…
                  </h3>
                </a>
              </article>
            </li>
