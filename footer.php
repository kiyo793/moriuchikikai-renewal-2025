      ...
      <div class="p-cta__inner">
        <div class="p-cta__body" data-animation="fade-in">
          ...
          <div class="p-cta__actions">
            <a href="<?php echo home_url(); ?>/contact" class="c-button c-button--blue">メールでのお問い合わせ</a>
          </div>
        </div>
      </div>
    </section>
  ...
  <footer class="l-footer">
    <div class="l-footer__inner" data-animation="fade-in">
      ...
      <nav
        ...
        <ul class="p-footer-nav__list" aria-label="事業メニュー">
          <li class="p-footer-nav__item">
            <a href="<?php echo home_url(); ?>/service" class="p-footer-nav__link">事業内容</a>
          </li>
          <li class="p-footer-nav__item">
            <a href="<?php echo home_url(); ?>/garbage-treatment-plant" class="p-footer-nav__link">ごみ処理プラント</a>
          </li>
          <li class="p-footer-nav__item">
            <a href="<?php echo home_url(); ?>/products" class="p-footer-nav__link">実績紹介</a>
          </li>
        </ul>

        <ul class="p-footer-nav__list" aria-label="企業情報">
          <li class="p-footer-nav__item">
            <a href="<?php echo home_url(); ?>/company" class="p-footer-nav__link">会社案内</a>
          </li>
          <li class="p-footer-nav__item">
            <a href="<?php echo home_url(); ?>/recruit" class="p-footer-nav__link">採用情報</a>
          </li>
          <li class="p-footer-nav__item">
            <a href="<?php echo home_url(); ?>/news" class="p-footer-nav__link">お知らせ</a>
          </li>
        </ul>

        <ul class="p-footer-nav__list" aria-label="お問い合わせ">
          <li class="p-footer-nav__item">
            <a href="<?php echo home_url(); ?>/contact" class="p-footer-nav__link">お問い合わせ</a>
          </li>
        </ul>
      ...
      <div class="l-footer__bottom">
        <small class="l-footer__copy">Copyright &copy; moriuchi machine Co.,Ltd. All rights
          reserved.</small>
      </div>
    </div>
  </footer>
